      ...
      <div className="w-full container mx-auto md:px-6">
        <div className="flex flex-col md:flex-row justify-between py-6  animation-from-left">
          ...
          <div  style={{"margin" :"auto"}} className=" md:mt-0 fade-up-element mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
            ...
            Your manuscript is ready but feeling a bit lost about how to publish it. No worries! At The Readsy, we've got your back. We promise to get your book the attention it deserves from the right readers. Our team of professionals is here to publish your book quickly and hassle-free.
            </p>
